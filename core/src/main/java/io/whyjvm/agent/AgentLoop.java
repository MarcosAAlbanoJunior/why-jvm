...
public final class AgentLoop {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            sub-spans no trace, chame get_slow_traces ANTES de concluir: ele mostra
            QUAL chamada (banco/downstream) dominou a latencia e detecta N+1 (muitas
            chamadas identicas). Se houver N+1, a causa raiz e a REPETICAO (ex.: 40x a
            mesma query 'SELECT orders'), nao uma chamada isolada nem 'park/espera'
            generico — diga isso explicitamente e quantifique (quantas chamadas e a
            % do tempo). Nao conclua 'espera externa' sem antes olhar o trace.
